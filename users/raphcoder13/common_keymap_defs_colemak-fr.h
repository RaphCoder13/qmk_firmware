...
const custom_shift_key_t custom_shift_keys[] = {
    ...
    {FR_LPRN, FR_SCLN, false},          // Shift ( is )
    ...
    {FR_EXLM, FR_SUP2, true},           // Shift ! is qs²
...
#define ________COLEMAK_FR_1DK_R3________        FR_K,            HOME_H_RALT,     FR_COMM,         FR_DOT,        FR_MINS
...
#define ____________SYMBOL_R1____________        FR_DQUO,              FR_LBRC,            FR_RBRC,        OSM(MOD_RALT),   KC_NO
#define ____________SYMBOL_R2____________        FR_GRV,               OSM(MOD_RCTL),      TD(TD_OSM_RSFT),  OSM(MOD_LALT),   OSM(MOD_RGUI)
#define ____________SYMBOL_R3____________        FR_QUOT,              FR_LCBR,            FR_RCBR,        FR_SCLN,         KC_NO
...
#define ____________NAV_L3____________           VIM_LAST_YANK,        LALT(KC_F4),        LCA(KC_LGUI),  OSM(MOD_RALT),   USR_REDO
#define ____________NAV_R1____________           KC_INS,               KC_HOME,            KC_END,         KC_NO,           KC_NO
#define ____________NAV_R2____________           KC_PSCR,              KC_LEFT,            KC_DOWN,        KC_UP,           KC_RIGHT
#define ____________NAV_R3____________           KC_PAUS,              KC_PGUP,            KC_PGDN,        KC_NO,           KC_APP
...
#define ___________MOUSE_L1___________           KC_NO,                USR_CUT,            USR_COPY,       USR_PASTE,       MOUSE_TOGGLE
#define ___________MOUSE_L2___________           OSM(MOD_LGUI),        OSM(MOD_LALT),      OSM(MOD_LSFT),  OSM(MOD_LCTL),   KC_ESC
#define ___________MOUSE_L3___________           KC_NO,                KC_RALT,            K_VSCROLL,      KC_MS_BTN4,      KC_MS_BTN5
#define ___________MOUSE_R1___________           KC_NO,                KC_MS_WH_UP,        KC_MS_UP,       KC_MS_WH_DOWN,   KC_NO
#define ___________MOUSE_R2___________           KC_NO,                KC_MS_LEFT,         KC_MS_DOWN,     KC_MS_RIGHT,     KC_NO
#define ___________MOUSE_R3___________           KC_NO,                KC_MS_WH_LEFT,      KC_NO,          KC_MS_WH_RIGHT,  KC_NO
