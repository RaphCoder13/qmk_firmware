...
#define UNI_UGRV_UPPER UM(UGRV_UPPER) // ù
#define UNI_EGRV_UPPER UM(EGRV_UPPER) // ù
#define UNI_EACU_UPPER UM(EACU_UPPER) // ù
...
#define UNI_APOSTROPHE UM(APOSTROPHE)
...
const custom_shift_key_t custom_shift_keys[] = {
    ...
    {FR_UGRV, UNI_UGRV_UPPER, false},    // Shift ù is Ù
    {FR_EGRV, UNI_EGRV_UPPER, false},    // Shift è is È
    {FR_EACU, UNI_EACU_UPPER, false},    // Shift é is É
...
#define ___________ACCENT_NEW_COLEMAK_R2___________          UNI_APOSTROPHE,       FR_EACU,          FR_EGRV,        FR_MICR,       FR_UGRV
