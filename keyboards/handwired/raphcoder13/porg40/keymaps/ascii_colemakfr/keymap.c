...
#include <common_keymap_defs_ascii_colemakfr.h>
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[COLEMAK_FR_1DK] = LAYOUT_wrapper(
        ...
        TD(TD_OSM_LSFT),	________COLEMAK_FR_1DK_L2________, KC_DOWN, KC_NO,                                        ________COLEMAK_FR_1DK_R2________,   FR_SLSH,
    ...
    [ACCENT_COLEMAK_LAYER] = LAYOUT_wrapper(
        ...
        KC_TRNS,___________ACCENT_NEW_COLEMAK_L3___________   , KC_TRNS, KC_TRNS               ,___________ACCENT_NEW_COLEMAK_R3___________                  ,	KC_TRNS,
                KC_TRNS, UNI_NOBRK_SPACE,	KC_TRNS,				KC_TRNS, KC_TRNS                  ,KC_TRNS,	KC_TRNS,	KC_DEL),
...
bool achordion_chord(uint16_t tap_hold_keycode, keyrecord_t *tap_hold_record, uint16_t other_keycode, keyrecord_t *other_record) {
    ...
    switch (tap_hold_keycode) {
        ...
        case HOME_S_SFT:
        case HOME_E_SFT:
            if ( other_keycode == UNI_EACU || other_keycode == UNI_EGRV
                || other_keycode == UNI_ETRM  || other_keycode == UNI_ECRC
                || other_keycode == UNI_ACRC || other_keycode == UNI_AGRV
                || other_keycode == UNI_ICRC || other_keycode == UNI_ITRM
                || other_keycode == UNI_UCRC || other_keycode == UNI_UGRV
                || other_keycode == UNI_OCRC
                || other_keycode == UNI_OE || other_keycode == UNI_AE )
                {
                    return true;
