...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[COLEMAK_FR_1DK] = LAYOUT_wrapper(
        MO(MOUSE_LAYER),	________COLEMAK_FR_1DK_L1________,                                        ________COLEMAK_FR_1DK_R1________,   LAYER_LOCK,
        ...
        TD(TD_SWAP_HANDS),	________COLEMAK_FR_1DK_L3________,                                        ________COLEMAK_FR_1DK_R3________,	TD(TD_SWAP_HANDS),
                LT(APPS_LAYER, KC_ESC), LT(EXCEL_LAYER, KC_SPC), LT(NAV, KC_TAB),RDB_REPEAT,          RDB_ALT_REPEAT, LT(NUMBERS, KC_ENT), LT(SYMB, KC_BSPC), LT(FUN, KC_DEL)),
    ...
    [GAME]   = LAYOUT_wrapper(
            ...
            KC_LCTL,____________QWERTY_L3____________                , ____________QWERTY_R3____________                 , KC_RCTL,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS, KC_TRNS, LAYER_LOCK),
    [SYMB]   = LAYOUT_wrapper(
            KC_TRNS, ____________SYMBOL_L1____________                ,    ____________SYMBOL_R1____________                , LAYER_LOCK,
            ...
            KC_TRNS, ____________SYMBOL_L3____________                ,    ____________SYMBOL_R3____________                , KC_TRNS,
                TG(GAME), QK_LEAD, KC_TAB,QK_REPEAT_KEY,                          KC_TRNS, KC_ENT,	KC_TRNS,	KC_DEL),
    [NUMBERS] = LAYOUT_wrapper(
            KC_NO,  ____________NUMBS_L1____________                 , ____________NUMBS_R1____________                 , LAYER_LOCK,
            ...
            KC_TRNS,____________NUMBS_L3____________                 , ____________NUMBS_R3____________                 , KC_TRNS,
                FR_DOT, KC_SPC,	KC_TAB, QK_ALT_REPEAT_KEY,						KC_TRNS, KC_TRNS,	KC_BSPC,	KC_DEL),
    [NAV]          = LAYOUT_wrapper(
            KC_NO,  ____________NAV_L1____________                   , ____________NAV_R1____________                  , LAYER_LOCK,
            KC_CAPS,____________NAV_L2____________                   , ____________NAV_R2____________                  , KC_NUM,
            KC_TRNS,____________NAV_L3____________                   , ____________NAV_R3____________                  , KC_TRNS,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    [FUN]          = LAYOUT_wrapper(
            KC_NO,   ____________FUN_L1____________                   , ____________FUN_R1____________                  , LAYER_LOCK,
    ...
    [APPS_LAYER]   = LAYOUT_wrapper(
            KC_NO,   ____________APPS_L1___________                   , ____________APPS_R1___________                  , LAYER_LOCK,
    ...
    [MOUSE_LAYER] = LAYOUT_wrapper(
            KC_TRNS, ___________MOUSE_L1___________           , ___________MOUSE_R1___________                , LAYER_LOCK,
            ...
            KC_TRNS, ___________MOUSE_L3___________           , ___________MOUSE_R3___________                , KC_TRNS,
             KC_MS_BTN2, KC_MS_BTN1, KC_MS_BTN3, KC_NO,                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

    [EXCEL_LAYER] = LAYOUT_wrapper(
            KC_TRNS,___________EXCEL_L1___________                   , ___________EXCEL_R1___________                  , LAYER_LOCK,
            ...
            KC_TRNS,___________EXCEL_L3___________                   , ___________EXCEL_R3___________                  , KC_TRNS,
                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                          QK_REPEAT_KEY, KC_PENT, KC_BSPC, KC_EQL),
...
bool process_alt_repeat_macros_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case MAG_DEBUG:  SEND_STRING(/*d*/"***REMOVED***"); break;
        case MAG_PHONE:  SEND_STRING(/*0*/"***REMOVED***"); break;
...
{
    if(rgblight_get_mode() != RGBLIGHT_MODE_RAINBOW_SWIRL)
        rgblight_mode_noeeprom(RGBLIGHT_MODE_RAINBOW_SWIRL);
    return true;
}
